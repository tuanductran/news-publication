...
if (class_exists('WP_Customize_Control')) {
   ...
   if (is_array($this->palette)) {
       ...
       // Default to true.
       $palette =
           false === $this->palette || 'false' === $this->palette
               ? 'false'
               : 'true';
   }
   ...
   $show_opacity =
       false === $this->show_opacity || 'false' === $this->show_opacity
           ? 'false'
           : 'true';
   $default = isset($this->settings['default']->default)
       ? $this->settings['default']->default
       : '';
   // Begin the output.
            ?>
			<label>
				<input class="alpha-color-control" type="text" data-show-opacity="<?php echo $show_opacity; ?>" data-palette="<?php echo esc_attr(
    $palette
