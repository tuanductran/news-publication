...
class Npub_Customizer
{
    ...
    {
        add_action('customize_register', [$this, 'include_controls']);
        add_action('customize_register', [$this, 'register_customizers']);
        add_action('customize_preview_init', [
            $this,
            'customize_preview_callback',
        ]);
    }
    ...
    {
        wp_enqueue_script(
            'npub-customizer_preview',
            NPUB_THEME_CUSTOMIZER_URI . '/js/customizer-preview.js',
    ...
    {
        $wp_customize->add_panel('site_layout_templates', [
            'priority' => 21,
        ...
        $wp_customize->add_panel('color_options_panel', [
            'priority' => 22,
            'capability' => 'edit_theme_options',
    ...
    {
        $wp_customize->add_section('header_controls_section', [
    ...
    public function header_layout($wp_customize)
    {
        ...
        $wp_customize->add_setting('header_layout_setting', [
                ...
                [
                    ...
                    'choices' => [
                        'header-default' => [
                            ...
                            'description' => __(
                                'Centered logo with two side widget areas. Full width menu.',
                                'news-publication'
                            ),
                        ...
                        'header-left' => [
                            ...
                            'description' => __(
                                'Left aligned logo no widget areas. Full width menu.',
                                'news-publication'
                            ),
    ...
    public function footer_layout($wp_customize)
    {
        ...
        $wp_customize->add_setting('footer_layout_setting', [
                ...
                [
                    ...
                    'choices' => [
                        'footer-default' => [
                            ...
                            'description' => __(
                                'Centered logo and description. Two menu areas, and one full width widget area.',
                                'news-publication'
                            ),
                        ...
                        'footer-default-col' => [
                            ...
                            'description' => __(
                                'Left logo and description. Two menu areas, arranged in 4 columns. One full width widget area.',
                                'news-publication'
                            ),
    ...
    {
        $wp_customize->add_setting('footer_copyright_setting', [
            'default' => __(
        ...
        $wp_customize->add_control(
            new WP_Customize_Control($wp_customize, 'textbox2_control', [
    ...
    {
        $wp_customize->add_section('single_article_layout_section', [
    ...
    public function single_article_bannner($wp_customize)
    {
        ...
        $wp_customize->add_setting('single_article_banner_setting', [
        ...
        $wp_customize->add_control(
            new Npub_Image_Select_Control(
                ...
                [
                    ...
                    'choices' => [
                        'article-banner-middle-title' => [
                            'label' => __('Modern header', 'news-publication'),
                            'description' => __(
                                'Title overlays the featured image partially.Center aligned.',
                                'news-publication'
                            ),
                            'url' => '%smodern-header.png',
                        ],
                        'article-banner-top-title-big' => [
                            'label' => __(
                                'Centered header',
                                'news-publication'
                            ),
                            'description' => __(
                                'Centered title and image. Title is displayed first, with added padding.',
                                'news-publication'
                            ),
                            'url' => '%scentered-header.png',
                        ],
                        'article-banner-top-title-small' => [
                            'label' => __('Classic header', 'news-publication'),
                            'description' => __(
                                'Left aligned title with smaller featured image.',
                                'news-publication'
                            ),
    ...
    {
        // Single Atricle Banner Options.
        $wp_customize->add_setting('single_article_content_setting', [
                ...
                [
                    ...
                    'choices' => [
                        'article-content' => [
                            ...
                            'description' => __(
                                'Center aligned body and no side widgets.',
                                'news-publication'
                            ),
                        ...
                        'article-content-sidebar' => [
                            ...
                            'description' => __(
                                'Left aligned body and widgets on the right.',
                                'news-publication'
                            ),
    ...
    {
        $wp_customize->add_section('font_colors_settings_section', [
            'title' => 'Font colors',
            'priority' => 30,
    ...
    {
        $wp_customize->add_section('site_element_colors_settings_section', [
    ...
    {
        $wp_customize->add_setting('body_bg_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#150E20',
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Changes the whole websites background color.',
                        'news-publication'
                    ),
    ...
    public function overlay_background_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('overlay_background_color_picker_setting', [
            'default' => '#190D29',
            'type' => 'theme_mod',
            'capability' => 'edit_theme_options',
            'transport' => 'refresh',
    ...
    public function accent_color_picker($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('accent_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#CCFF2E',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Open the color picker and select "default" to go back to the original setting.',
                        'news-publication'
                    ),
    ...
    public function headers_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('headers_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#ffffff',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Change color for H1/H2/H3/H4 Titles & Subtitles',
                        'news-publication'
                    ),
                    'section' => 'font_colors_settings_section',
    ...
    public function secondary_text_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('secondary_text_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#7E7689',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Change color for secondary text (e.g author name & date)',
                        'news-publication'
                    ),
                    'section' => 'font_colors_settings_section',
    ...
    {
        // Secondary Text Color Control Picker Control.
        $wp_customize->add_setting('headline_text_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#ffffff',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Change color for headline text',
                        'news-publication'
                    ),
                    'section' => 'font_colors_settings_section',
    ...
    public function text_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('text_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#FFFFFF',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Change color for body text (paragraph styling)',
                        'news-publication'
                    ),
                    'section' => 'font_colors_settings_section',
    ...
    public function link_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('link_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#FFFFFF',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
    ...
    public function body_secondary_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('body_secondary_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#392E49',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Border color for things like inputs, search, news ticker & hover menus.',
                        'news-publication'
                    ),
                    'section' => 'site_element_colors_settings_section',
    ...
    public function post_card_hover_color($wp_customize, $priority)
    {
        ...
        $wp_customize->add_setting('post_card_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#21172E',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'Change hover color of post card block.',
                        'news-publication'
                    ),
                    'section' => 'site_element_colors_settings_section',
    ...
    {
        // Headline section background color.
        $wp_customize->add_setting('headline_background_color_picker_setting', [
            'transport' => 'refresh',
            'default' => '#211732',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                [
                    ...
                    'description' => __(
                        'BG color for news ticker bar below the navbar.',
                        'news-publication'
                    ),
                    'section' => 'site_element_colors_settings_section',
    ...
    public function header_logosize_list($wp_customize)
    {
        ...
        $wp_customize->add_control(
            new Npub_Range_Control($wp_customize, 'logo_width', [
                'type' => 'range-value',
                'section' => 'title_tagline',
                'settings' => 'logo_width',
                'label' => __(
                    'Header Logo Width for Desktop',
                    'news-publication'
                ),
                'input_attrs' => [
                    'min' => 1,
        ...
        $wp_customize->add_control(
            new Npub_Range_Control($wp_customize, 'mobile_logo_width', [
                'type' => 'range-value',
                'section' => 'title_tagline',
                'label' => __(
                    'Header Logo Width for Mobile',
                    'news-publication'
                ),
    ...
    public function footer_logosize_list($wp_customize)
    {
        ...
        $wp_customize->add_control(
            new Npub_Range_Control($wp_customize, 'footer_logo_width', [
                'type' => 'range-value',
                'section' => 'title_tagline',
                'settings' => 'footer_logo_width',
                'label' => __(
                    'Footer Logo Width for Desktop',
                    'news-publication'
                ),
                'input_attrs' => [
                    'min' => 1,
        ...
        $wp_customize->add_setting('footer_mobile_logo_width', [
        ...
        $wp_customize->add_control(
            new Npub_Range_Control($wp_customize, 'footer_mobile_logo_width', [
                'type' => 'range-value',
                'section' => 'title_tagline',
                'label' => __(
                    'Footer Logo Width for Mobile',
                    'news-publication'
                ),
