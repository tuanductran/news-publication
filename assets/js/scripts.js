...
function sidebar_position(){
  ...
  if (1024 < $(window).width()) {
    $('.single-post.article-banner-top-title-small .sticky-side-disabled.sidebar-cont').css("margin-top", mt);
  }else{
    $('.single-post.article-banner-top-title-small .sticky-side-disabled.sidebar-cont').removeAttr("style");
  }
}   

/*** mega menu padding ***/ 
$(document).ready(function(){
  if ( 0 < $('.col-lg-1.col-1.mobile-nav-btn.wrapper').length || 0 < $('.mobile-nav-btn-expanded.wrapper').length ) {
    megamenu_position();
  }
});
$(window).resize(function () {
...
function megamenu_position(){
  ...
  if (1279 < $(window).width()) {
    if (0 < $('.col-lg-1.col-1.mobile-nav-btn.wrapper').length) {
      ...
      $('body').append('<style>body.mobile_nav_visiable:not(.body-fixed) .mega_menu_wrapper{padding-top: '+ dmpadd +'px;}</style>');
    }
    ...
    if (0 < $('.mobile-nav-btn-expanded.wrapper').length) {
      ...
      $('body').append('<style>body.mobile_nav_visiable:not(.body-fixed) .mega_menu_wrapper{padding-top: '+ dmpadde +'px;}</style>');
    }
  }
}
